    ...
    .catch(error => console.log(error))
        ...
        const mostrarData_tours = (data) =>{
            ...
            for(let i = 0; i< data.length; i++){
                ...
                <td><button type="submit" class="btn btn-primary col-sm-12">Eliminar</button></td></tr>`
            }
            document.getElementById('tours').innerHTML = body
        }
        ...
        const mostrarData_transportes = (data) =>{
             console.log(data);
                ...
                for(let i = 0; i< data.length; i++){
                    ...
                    document.getElementById('transportes').innerHTML = body
            }